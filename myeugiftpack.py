...
Original file is located at
    https://colab.research.google.com/drive/1u75v6AFw3WGrFxXW5kxt_TqRrPvRw0L0
"""
        ...
        if not seat_num:
            ...
            with st.spinner("Đang dò tìm và cập nhật dữ liệu..."):
                try:
                    ...
                    # Lấy toàn bộ dữ liệu hiện tại của Sheet về dò cho lẹ
                    ...
                    # Dò từ dưới lên trên (để lấy dữ liệu ghi nhận mới nhất nếu có người nhập 2 lần)
                    for i in range(len(all_data) - 1, 0, -1):
                        ...
                        if sheet_seat == seat_normalized:
                            row_to_update = i + 1 # +1 vì gspread đếm dòng bắt đầu từ 1, mảng Python đếm từ 0

                            # Kiểm tra xem đã có người đóng thùng trước đó chưa (Cột E / index 4)
                    ...
                    if row_to_update == -1:
                        ...
                        # Update vào Sheet (Cột E: Packed, Cột F: Số Thùng)
                        sheet.update_cell(row_to_update, 5, "✅")
                        sheet.update_cell(row_to_update, 6, str(box_num))
